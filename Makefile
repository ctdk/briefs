...
briefs_fs-objs := init.o alloc.o journal.o crc32c.o ops.o trie.o trie_page.o super.o inode.o dir.o file.o extent.o btree.o debug.o sysfs.o proc.o export.o iomap.o xattr.o acl.o
